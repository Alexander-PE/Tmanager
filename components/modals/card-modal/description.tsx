        ...
        {isEditing ?
          (
            <form ref={formRef} className="space-y-2" action={onSubmit}>
              <FormTextarea errors={fieldErrors} ref={textareaRef} id="description" defaultValue={data.description || undefined} placeholder="Add a detailed description..." className="w-full mt-2" />
